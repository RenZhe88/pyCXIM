...
from pyCXIM.RSM.RSM_6C import cal_q_pos
...
def BCDI_preparation():
    ...
    if geometry == 'out_of_plane':
        q_vector = cal_q_pos(pch[1:], [omega[pch[0]], delta, chi, phi, gamma, mu, energy], [distance, pixelsize, det_rot, cch])
    elif geometry == 'in_plane':
        q_vector = cal_q_pos(pch[1:], [omega, delta, chi, phi[pch[0]], gamma, mu, energy], [distance, pixelsize, det_rot, cch])
    print(q_vector)
