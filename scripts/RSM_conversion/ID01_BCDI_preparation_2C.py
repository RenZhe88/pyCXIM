...
from pyCXIM.scan_reader.ESRF.edf_reader import ESRFEdfImporter
...
def BCDI_preparation():
    ...
    path = r"F:\Raw Data\20141204 ID01\hs4670inhouse"
    # the aimed saving folder
    pathsavefolder = r"F:\Work place 4\Temp"
    # the path for the mask file for the detector
    pathmask = r'F:\Work place 3\testprog\pyCXIM_master\detector_mask\id01_maxipix_mask.npy'
    ...
    scan = ESRFEdfImporter('ID01', path, spec_name, scan_num, detector, prefix, pathsavefolder, pathmask)
    print(scan)
    scan.change_image_infor(r'F:\Raw Data\20141204 ID01\hs4670inhouse\Au_NW_C3')
    ...
    infor.add_para('spec_name', section_ar[0], spec_name)
